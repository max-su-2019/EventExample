#include "SKSEMessageEvent.h"
#include "BSTScriptEvent.h"
...
extern "C" DLLEXPORT bool SKSEAPI SKSEPlugin_Load(const SKSE::LoadInterface* a_skse)
{
	...
	MessageEvent::Register();	//Register SKSE Message Event
	OnHitEventHandler::Register();	//Register Bethesda Script Event
